...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<Customer> descOrder = (a, b) -> b.getBudget() - a.getBudget();
        Stream<String> top3RichCustomerStream = customerList.stream().sorted(descOrder).limit(3).map(Customer::getName);
